...
def home(request,u_id):
	...
	guy=[]
	focus=[]
	f=Follow_user.objects.filter(user_id=u_id)
	for j in f:
	...
	return render(request,'users/home.html',{'reward':reward,'follow_group_set1':follow_group_set1,'follow_group_set2':follow_group_set2,'tab':tab,'couses':couses,'mygroup':mygroup,'identity':identity,'userinfo':userinfo,'info':info,'guy':guy,'news':news,'havent':havent})
