...
function comment_t(id){
	...
	var url="http://192.168.1.109:8866/users/comment/?content="+content+"&news_id="+id;
	...
	xmlHttp.onreadystatechange=function(){
		if(xmlHttp.readyState==4 && xmlHttp.status==200){
				...
				var str1='<div class="pull-left comment_img"><a href="http://192.168.1.109:8866/users/home/';
				var str2='"><img src="../avatar/';
...
{//alert(news_id+'---'+re_id+'---'+to);
	...
	var url="http://192.168.1.109:8866/users/cocomment/?content="+content+"&news_id="+news_id+"&re_id="+re_id+"&to="+to;
	xmlHttp.open("GET",url);
	xmlHttp.onreadystatechange=function(){
		if(xmlHttp.readyState==4 && xmlHttp.status==200){
...
function get_more_re(news_id)
{
	createXMLRequest();                       
	var content=document.getElementById("comment_tarea"+news_id).value;
	var url="http://192.168.1.109:8866/users/get_more_re/?&news_id="+news_id;
	xmlHttp.open("GET",url);
	xmlHttp.onreadystatechange=function(){
		if(xmlHttp.readyState==4 && xmlHttp.status==200){
				...
				$.each(re_news_big_array, function(i,val){      
					    ...
					    {
						    var str1='<div class="comment_a_style"><div class="pull-left comment_img"><a href="http://192.168.1.109:8866/users/home/';
							var str2='"><img src="../avatar/';
							var str3='" class="img-circle" width="100%"></a></div><div class="pull-left comment_content"><div><div class="pull-left"><a href="http://192.168.1.109:8866/users/home/';
							var str4='"><b>';
